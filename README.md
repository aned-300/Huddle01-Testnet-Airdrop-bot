...
Follow these steps to install the Huddle01-Testnet-Airdrop-bot on your computer:

1. **Download the Software:**
   - From the Releases page, find and click the latest version of the software.
   - Save the file to a location on your computer.

2. **Extract the Files:**
   - Locate the downloaded file.
   - If it is a ZIP file, right-click on it and select "Extract All" or use a program like WinRAR.

3. **Install Dependencies:**
   - Open a terminal (Command Prompt, PowerShell, or Terminal).
   - Navigate to the folder where you extracted the files. You can do this by typing `cd path/to/folder` (replace "path/to/folder" with the actual path).
   - Install the required dependencies by running:
     ```
     npm install
     ```

## ⚙️ Using Huddle01-Testnet-Airdrop-bot
After installation, you are ready to use the bot.

1. **Configure Wallet Accounts:**
   - Open the configuration file in your favorite text editor.
   - Add your wallet addresses in the specified section of the file.
...
3. **Monitor Progress:**
   - Keep an eye on the terminal to see updates as the bot joins rooms and collects points.

## 🛠️ Features
- Join multiple Huddle01 rooms at the same time.
- Automate participation to maximize testnet points.
- Simple interface for adding wallet accounts.
...
For specific error messages, refer to the error logs in the terminal for guidance.

## 🤝 Contributing
If you wish to contribute to the Huddle01-Testnet-Airdrop-bot project:
